...
class MenuController extends BackendBaseController
{
    ...
    public function store(Request $request)
    {
        ...
        $validatedData = $request->validate([
            ...
            'code' => 'nullable|max:191|unique:'.$module_model.',code',
            'bar_code' => 'nullable|max:191|unique:'.$module_model.',bar_code',
    ...
    public function update(Request $request, $id)
    {
        ...
        $validatedData = $request->validate([
            ...
            'bar_code' => 'nullable|max:191|unique:'.$module_model.',bar_code,'.$id,
