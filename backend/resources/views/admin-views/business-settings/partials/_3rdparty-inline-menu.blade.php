...
{{--            <li class="{{Request::is('admin/business-settings/web-app/third-party/fcm-index')? 'active': ''}}"><a href="{{route('admin.business-settings.web-app.third-party.fcm-index')}}">{{translate('Push_Notification')}}</a></li>--}}
            ...
            <li class="{{Request::is('admin/business-settings/web-app/third-party/firebase-otp-verification')? 'active': ''}}"><a href="{{route('admin.business-settings.web-app.third-party.firebase-otp-verification')}}">{{translate('Firebase_OTP_verification')}}</a></li>
        </ul>
    </div>
</div>
