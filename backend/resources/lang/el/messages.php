<?php return array (
  ...
  'The first name field is required.' => 'Το πεδίο ονόματος είναι υποχρεωτικό.',
  'The last name field is required.' => 'Το πεδίο επωνύμου είναι υποχρεωτικό.',
  'Email sent successfully.' => 'Το email στάλθηκε με επιτυχία.',
  'payment_gateway_title_is_empty!' => 'Ο τίτλος της πύλης πληρωμής είναι κενός!',
  'payment_gateway_title_is_required!' => 'Απαιτείται τίτλος πύλης πληρωμής!',
  'Offline payment information' => 'Πληροφορίες πληρωμής εκτός σύνδεσης',
  'payment_note' => 'Payment note',
  ...
  'Successfully login.' => 'Επιτυχής είσοδος.',
  'Verify_Offline_Payment' => 'Επαλήθευση πληρωμής εκτός σύνδεσης',
  'verify_offline_payments' => 'Επαληθεύστε τις πληρωμές εκτός σύνδεσης',
